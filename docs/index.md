...
> **RAG** — Démo interactive de question-réponse sur PDF via LlamaIndex, HuggingFace embeddings et Gemini 2.5 Flash.
...
| Une décision d'architecture historique | — (pas d'ADR pour l'instant) |
...
|---|---|---|---|---|
| [architecture.md](architecture.md) | 2026-05-20 | — | Brouillon | — |
| [data-model.md](data-model.md) | 2026-05-20 | — | Brouillon | — |
| [contracts.md](contracts.md) | 2026-05-20 | — | Brouillon | — |
| [glossaire.md](glossaire.md) | 2026-05-20 | — | Brouillon | — |
| [fonctionnel.md](fonctionnel.md) | 2026-05-20 | — | Brouillon | — |
...
|---|---|---|---|
| RAGEngine | CLI / Lib | [architecture.md](architecture.md) | [rag_engine.py](../rag_engine.py) |
...
|---|---|---|
| arxiv.org | Source du PDF de démo (arXiv 2005.11401 — RAG original paper) | https://arxiv.org/abs/2005.11401 |
| LlamaIndex docs | Framework RAG principal | https://docs.llamaindex.ai |
| — | Pas de dashboard, runbook ou wiki externe pour ce projet CLI | — |
