...
| **Mise à jour par** | agent IA (bt-ai:doc-sync) |
| **PR de référence** | — |
| **Version applicative** | 0.0.0 |

> **RAG** — Pipeline de Retrieval-Augmented Generation qui charge un PDF, construit un index vectoriel sémantique et répond à des questions en langage naturel via Gemini, pour un utilisateur CLI.
