...
| **PR de référence** | — |
| **Version applicative** | 6d1386c |

> **RAG** — Pipeline RAG interactif : charge un PDF depuis une URL, construit un index vectoriel avec HuggingFace bge-small-en-v1.5, et répond aux questions en langage naturel via Gemini 2.5 Flash.
...
|---|---|---|---|---|
| [architecture.md](architecture.md) | 2026-05-24 | — | Brouillon | — |
| [data-model.md](data-model.md) | 2026-05-24 | — | Brouillon | — |
| [contracts.md](contracts.md) | 2026-05-24 | — | Brouillon | — |
| [glossaire.md](glossaire.md) | 2026-05-24 | — | Brouillon | — |
| [fonctionnel.md](fonctionnel.md) | 2026-05-24 | — | Brouillon | — |
