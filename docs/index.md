...
> **RAG** — Pipeline de Retrieval-Augmented Generation qui indexe un PDF distant, persiste les embeddings sur disque et répond à des questions en langage naturel via Gemini 2.5-flash, pour tout utilisateur en ligne de commande.
