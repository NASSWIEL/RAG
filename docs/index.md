...
> **RAG** — Pipeline de question-réponse en mode RAG (Retrieval-Augmented Generation) sur documents PDF, via LlamaIndex, HuggingFace Embeddings et Gemini.
...
| Une décision d'architecture historique | — |
...
|---|---|---|---|---|
| [architecture.md](architecture.md) | 2026-05-10 | — | Brouillon | — |
| [data-model.md](data-model.md) | 2026-05-10 | — | Brouillon | — |
| [contracts.md](contracts.md) | 2026-05-10 | — | Brouillon | — |
| [glossaire.md](glossaire.md) | 2026-05-10 | — | Brouillon | — |
| [fonctionnel.md](fonctionnel.md) | 2026-05-10 | — | Brouillon | — |
...
|---|---|---|---|
| RAG | CLI / Lib | [architecture.md](architecture.md) | [rag_engine.py](../rag_engine.py) |
...
| Espace wiki | Décisions process, comptes-rendus | — |
