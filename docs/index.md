...
> **RAG** — Moteur de questions-réponses basé sur la récupération augmentée (RAG) : indexe un PDF distant, génère des réponses via Gemini LLM, pour un usage en ligne de commande.
