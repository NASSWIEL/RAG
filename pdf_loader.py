"""Utilities for loading PDF documents from URLs or local paths."""
...
def load_pdf_from_url(url):
    """Download a PDF from a URL and save it to a temporary local file.
...
def load_documents_from_pdf(pdf_path):
    ...
    Returns:
        list: The list of documents extracted from the PDF.
    """
    loader = PDFReader()
