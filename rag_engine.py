...
class RAGEngine:
    """Retrieval-Augmented Generation engine that indexes a PDF and answers queries."""

    def __init__(self, pdf_url, storage_dir="./storage"):
        """Set up the RAG engine by loading or building the vector index for the given PDF URL."""
    ...
    def query(self, question):
        """Query the vector index and return a generated answer for the given question.
