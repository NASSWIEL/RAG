...
class RAGEngine:
    ...
    def __init__(self, pdf_url, storage_dir="./storage"):
        """Initialize the RAG engine, loading or building a vector index for the given PDF URL."""
    ...
    def query(self, question):
        """Query the index and return a generated answer for the given question.
