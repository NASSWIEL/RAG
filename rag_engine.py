"""RAG engine for indexing and querying PDF documents using vector embeddings."""
...
class RAGEngine:
    ...
    def __init__(self, pdf_url, storage_dir="./storage"):
        """Initialize the RAG engine by loading or building the vector index for the given PDF URL.
        """
    ...
    def query(self, question):
        """Query the index with a natural language question and return the answer as a string.

        Args:
            question: The natural language question to ask against the indexed PDF.
