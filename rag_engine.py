...
class RAGEngine:
    """Retrieval-Augmented Generation engine backed by a LlamaIndex vector store."""

    def __init__(self, pdf_url, storage_dir="./storage"):
        """Initialize the RAG engine, loading or building the vector index for the given PDF URL."""
    ...
    def query(self, question):
        """Query the index with a natural-language question and return the generated answer.

        Args:
            question: The question to answer using the indexed PDF content.
