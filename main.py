"""Entry point for the RAG-based interactive question-answering application."""

from rag_engine import RAGEngine


def main():
    """Run an interactive question-answering session using a RAG engine over a PDF document."""
